...
//   console.log(currentUserInfo, "profile data");
...
//         image_url: currentUserInfo?.imageUrl,
...
//       };
//       const updatedInfo = await updateProfile(selectedValues);
//       console.log(updatedInfo,89);
//       if(updatedInfo?.data?.success){
//           message.success(updatedInfo?.data?.message);
//       }
//     } catch (error) {
...
const CLOUDINARY_UPLOAD_PRESET = "mern_product";
const CLOUDINARY_CLOUD_NAME = "djzt5tkwu";
